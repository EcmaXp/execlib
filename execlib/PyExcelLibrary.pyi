...
class DialogFrame:
    ...
    def copy_picture(self, appearance = None, format = None) -> object: pass
...
class Windows:
    ...
    def arrange(self, arrange_style = None, active_workbook: object = None, sync_horizontal: object = None, sync_vertical: object = None) -> object: pass
...
class Sheets:
    ...
    def fill_across_sheets(self, range: RangeType, type = None): pass
...
class TimelineState:
    ...
    def set_filter_date_range(self, start_date: object, end_date: object): pass
...
class ListObjects:
    ...
    def add(self, source_type = None, source: object = None, link_source: object = None, xl_list_object_has_headers = None, destination: object = None) -> ListObjectType: pass

    count: int

    def add_ex(self, source_type = None, source: object = None, link_source: object = None, xl_list_object_has_headers = None, destination: object = None, table_style_name: object = None) -> ListObjectType: pass
...
class FormatConditions:
    ...
    def add(self, type, Operator: object = None, formula1: object = None, formula2: object = None, String: object = None, text_operator: object = None, date_operator: object = None, scope_type: object = None) -> object: pass
...
class Workbook:
    ...
    def change_file_access(self, mode, write_password: object = None, notify: object = None): pass


    def change_link(self, name: str, new_name: str, type = None): pass
    ...
    def link_info(self, name: str, link_info, type: object = None, edition_ref: object = None) -> object: pass
    ...
    def run_auto_macros(self, which): pass
    ...
    def send_mailer(self, file_format: object = None, priority = None): pass
    ...
    def break_link(self, name: str, type): pass


    def save_as(self, filename: object = None, file_format: object = None, password: object = None, write_res_password: object = None, read_only_recommended: object = None, create_backup: object = None, access_mode = None, conflict_resolution: object = None, add_to_mru: object = None, text_codepage: object = None, text_visual_layout: object = None, local: object = None): pass
    ...
    def xml_import(self, url: str, import_map: XmlMapType, overwrite: object = None, destination: object = None): pass
    ...
    def xml_import_xml(self, data: str, import_map: XmlMapType, overwrite: object = None, destination: object = None): pass
    ...
    def remove_document_information(self, remove_doc_info_type): pass
    ...
    def export_as_fixed_format(self, type, filename: object = None, quality: object = None, include_doc_properties: object = None, ignore_print_areas: object = None, from_: object = None, to: object = None, open_after_publish: object = None, fixed_format_ext_class_ptr: object = None): pass
    ...
    def save_as2(self, filename: object = None, file_format: object = None, password: object = None, write_res_password: object = None, read_only_recommended: object = None, create_backup: object = None, access_mode = None, conflict_resolution: object = None, add_to_mru: object = None, text_codepage: object = None, text_visual_layout: object = None, local: object = None, work_identity: object = None): pass


    def export_as_fixed_format2(self, type, filename: object = None, quality: object = None, include_doc_properties: object = None, ignore_print_areas: object = None, from_: object = None, to: object = None, open_after_publish: object = None, fixed_format_ext_class_ptr: object = None, work_identity: object = None): pass


    def publish_to_docs(self, title: str, disclosure_scope, overwrite_url: object = None) -> str: pass
...
class PivotFilters:
    ...
    def add(self, type, data_field: object = None, value1: object = None, value2: object = None, order: object = None, name: object = None, description: object = None, member_property_field: object = None) -> PivotFilterType: pass


    def add2(self, type, data_field: object = None, value1: object = None, value2: object = None, order: object = None, name: object = None, description: object = None, member_property_field: object = None, whole_day_filter: object = None) -> PivotFilterType: pass
...
class Shapes:
    ...
    def add_form_control(self, type, left: int, top: int, width: int, height: int) -> ShapeType: pass
...
class SparklineGroups:
    ...
    def add(self, type, source_data: str) -> SparklineGroupType: pass
...
class XmlMap:
    ...
    def import_(self, url: str, overwrite: object = None): pass


    def import_xml(self, xml_data: str, overwrite: object = None): pass


    def export(self, url: str, overwrite: object = None): pass


    def export_xml(self, data: str): pass
...
class HPageBreak:
    ...
    def drag_off(self, direction, region_index: int): pass
...
class Parameter:
    ...
    def set_param(self, type, value: object): pass
...
class PublishObjects:
    ...
    def add(self, source_type, filename: str, sheet: object = None, source: object = None, html_type: object = None, div_id: object = None, title: object = None) -> PublishObjectType: pass
...
class DataFeedConnection:
    ...
    refresh_period: int
    save_password: bool
    server_credentials_method: None
...
class Application:
    ...
    def activate_microsoft_app(self, index): pass
    ...
    color_buttons: bool
    command_underlines: None
    constrain_numeric: bool

    def convert_formula(self, formula: object, from_reference_style, to_reference_style: object = None, to_absolute: object = None, relative_to: object = None) -> object: pass
    ...
    display_comment_indicator: None
    ...
    move_after_return_direction: None
    ...
    calculation_interrupt_key: None
    watches: WatchesType
...
class Dialogs:
    ...
    def __iter__(self, index) -> Iterable[DialogType]: pass
    ...
    def get(self, index) -> DialogType: pass
...
class CubeFields:
    ...
    def get_measure(self, attribute_hierarchy: object, function, caption: object = None) -> CubeFieldType: pass
...
class TextConnection:
    ...
    text_file_parse_type: None
    text_file_platform: None
...
class ListObject:
    ...
    def update_changes(self, i_conflict_type = None): pass
...
class QuickAnalysis:
    ...
    def show(self, xl_quick_analysis_mode = None): pass


    def hide(self, xl_quick_analysis_mode = None): pass
...
class Chart:
    ...
    def axes(self, type: object = None, axis_group = None) -> object: pass
    ...
    def copy_picture(self, appearance = None, format = None, size = None): pass

    corners: CornersType

    def create_publisher(self, edition: object = None, appearance = None, size = None, contains_pict: object = None, contains_biff: object = None, contains_rtf: object = None, contains_valu: object = None): pass
    ...
    def location(self, where, name: object = None) -> ChartType: pass
    ...
    def apply_custom_type(self, chart_type, type_name: object = None): pass
    ...
    def apply_data_labels(self, type = None, legend_key: object = None, auto_text: object = None, has_leader_lines: object = None, show_series_name: object = None, show_category_name: object = None, show_value: object = None, show_percentage: object = None, show_bubble_size: object = None, separator: object = None): pass
...
class Borders:
    ...
    def __iter__(self, index) -> Iterable[BorderType]: pass
    ...
    def get(self, index) -> BorderType: pass
...
class Range:
    ...
    def get_address(self, row_absolute: object = None, column_absolute: object = None, reference_style = None, external: object = None, relative_to: object = None) -> str: pass


    def get_address_local(self, row_absolute: object = None, column_absolute: object = None, reference_style = None, external: object = None, relative_to: object = None) -> str: pass


    def advanced_filter(self, action, criteria_range: object = None, copy_to_range: object = None, unique: object = None) -> object: pass


    def apply_names(self, names: object = None, ignore_relative_absolute: object = None, use_row_column_names: object = None, omit_column: object = None, omit_row: object = None, order = None, append_last: object = None) -> object: pass
    ...
    def auto_fill(self, destination: RangeType, type = None) -> object: pass


    def auto_filter(self, field: object = None, criteria1: object = None, Operator = None, criteria2: object = None, visible_drop_down: object = None) -> object: pass


    def auto_fit(self) -> object: pass


    def auto_format(self, format = None, number: object = None, font: object = None, alignment: object = None, border: object = None, pattern: object = None, width: object = None) -> object: pass


    def auto_outline(self) -> object: pass


    def border_around(self, line_style: object = None, weight = None, color_index = None, color: object = None) -> object: pass
    ...
    def create_publisher(self, edition: object = None, appearance = None, contains_pict: object = None, contains_biff: object = None, contains_rtf: object = None, contains_valu: object = None) -> object: pass
    ...
    def data_series(self, rowcol: object = None, type = None, date = None, step: object = None, stop: object = None, trend: object = None) -> object: pass
    ...
    def edition_options(self, type, option, name: object = None, reference: object = None, appearance = None, chart_size = None, format: object = None) -> object: pass


    def get_end(self, direction) -> RangeType: pass
    ...
    def find(self, what: object, after: object = None, look_in: object = None, look_at: object = None, search_order: object = None, search_direction = None, match_case: object = None, match_byte: object = None, search_format: object = None) -> RangeType: pass
    ...
    def sort(self, key1: object = None, order1 = None, key2: object = None, type: object = None, order2 = None, key3: object = None, order3 = None, header = None, order_custom: object = None, match_case: object = None, orientation = None, sort_method = None, data_option1 = None, data_option2 = None, data_option3 = None) -> object: pass


    def sort_special(self, sort_method = None, key1: object = None, order1 = None, type: object = None, key2: object = None, order2 = None, key3: object = None, order3 = None, header = None, order_custom: object = None, match_case: object = None, orientation = None, data_option1 = None, data_option2 = None, data_option3 = None) -> object: pass

    sound_note: SoundNoteType

    def special_cells(self, type, value: object = None) -> RangeType: pass

    style: object

    def subscribe_to(self, edition: str, format = None) -> object: pass


    def subtotal(self, group_by: int, function, total_list: object, replace: object = None, page_breaks: object = None, summary_below_data = None) -> object: pass
    ...
    def paste_special(self, paste = None, operation = None, skip_blanks: object = None, transpose: object = None) -> object: pass
    ...
    def remove_duplicates(self, columns: object = None, header = None): pass
    ...
    def border_around2(self, line_style: object = None, weight = None, color_index = None, color: object = None, theme_color: object = None) -> object: pass
...
class TableStyleElements:
    ...
    def item(self, index) -> TableStyleElementType: pass
...
class Validation:
    ...
    def add(self, type, alert_style: object = None, Operator: object = None, formula1: object = None, formula2: object = None): pass
...
class DefaultPivotTableLayoutOptions:
    ...
    layout_blank_line: bool
    row_axis_layout: None
    repeat_all_labels: None
...
class PivotTable:
    ...
    def pivot_select(self, name: str, mode = None, use_standard_name: object = None): pass
    ...
    compact_row_indent: int
    layout_row_default: None
    display_field_captions: bool

    def row_axis_layout(self, row_layout): pass


    def subtotal_location(self, location): pass
    ...
    def repeat_all_labels(self, repeat): pass
...
class PivotCaches:
    ...
    def add(self, source_type, source_data: object = None) -> PivotCacheType: pass


    def create(self, source_type, source_data: object = None, version: object = None) -> PivotCacheType: pass
